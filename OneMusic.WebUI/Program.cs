...
builder.Services.AddControllersWithViews(option =>
{
    ...
    option.Filters.Add(new AuthorizeFilter(authorizePolicy)); //kimlerin girebileceðinin yetkilendirmesini yaptýk 
});




builder.Services.ConfigureApplicationCookie(options => //giriþ çýkýþ tüm iþlemleri buradan yapýyoruz 
{
